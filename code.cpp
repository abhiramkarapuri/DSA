...
//FRACTIONAL KNAPSACK TC = O(N + NlogN), SC = O(1)
// class Item {
// public:
//     int value;
//     int weight;
...
//DIVIDE 2 NUMBERS USING BITWISE 
...
//     int W = 7;
//     cout << "Maximum value = " << knapsack(W, wt, val, wt.size()) << endl;
// }
...
// vector<vector<int>> lcsTable(string &A, string &B) {
